...
@section('content')
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('pengelolaan-informasi/kategoriibadah') }}" class="form-horizontal">
                @csrf
                <div class="form-group row align-items-center">
                    <label class="col-md-1 control-label col-form-label">Kategori Ibadah Kode<span class="text-danger">*</span></label>
                    <div class="col-md-11">
                        <input type="text" class="form-control" id="kategoriibadah_kode" name="kategoriibadah_kode" value="{{ old('kategoriibadah_kode') }}" required>
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-md-11">
                        <input type="text" class="form-control" id="kategoriibadah_nama" name="kategoriibadah_nama" value="{{ old('kategoriibadah_nama') }}" required>

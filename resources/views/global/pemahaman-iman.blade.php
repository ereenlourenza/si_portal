...
@section('content')
    ...
    <section class="max-w-5xl mx-auto px-4 py-12 text-gray-800 leading-relaxed">
        ...
        <div class="max-w-4xl mx-auto px-4 py-4">
            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">I KESELAMATAN</h2>
            <p class="mb-4">KAMI MENGAKU,</p>
            ...
            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">II GEREJA</h2>    
            <ol class="list-decimal list-outside pl-6 mb-6 space-y-1">
                ...
                <li>Bahwa Tuhan yang memanggil dan menetapkan para pelayan-Nya 1) sebagai Presbiter 2) yang berjalan bersama-sama 3) untuk memperlengkapi warga 4)Â GPIBÂ yang missioner 5) sebagai manusia yang utuh.</li>
            </ol>

            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">III MANUSIA</h2>    
            <ol class="list-decimal list-outside pl-6 mb-6 space-y-1">
            ...
            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">IV ALAM DAN SUMBER DAYA</h2>    
            <ol class="list-decimal list-outside pl-6 mb-6 space-y-1">
            ...
            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">V NEGARA DAN BANGSA</h2>    
            <ol class="list-decimal list-outside pl-6 mb-6 space-y-1">
                ...
                <li>Bahwa berdasarkan tuntunan Roh Kudus, warga jemaat yang adalah sekaligus warga negara, di dalam kehidupan bernegara, berbangsa, dan bermasyarakat, perlu mem-bangun rasa persatuan dan kesatuan 1) yang tidak merusak kebhinekaan dan kesetaraan 2) yang telah menjadi bagian dari masyarakat warga ( civil -society ), di mana hak â€“ hak asasi manusia dijunjung tinggi 3).</li>
            </ol>

            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">VI MASA DEPAN</h2>    
            <ol class="list-decimal list-outside pl-6 mb-6 space-y-1">
            ...
            <h2 class="text-xl md:text-2xl font-semibold text-amber-700 mb-4 mt-10">VII FIRMAN ALLAH</h2>    
            <ol class="list-decimal list-outside pl-6 mb-6 space-y-1">

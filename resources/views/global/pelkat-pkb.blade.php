...
<div class="max-w-5xl mx-auto px-4 py-12 leading-relaxed">
    ...
    <div class="max-w-4xl mx-auto px-4 py-4">
        ...
        <div class="bg-[#73706F] border-l-4 border-[#73706F] p-6 rounded shadow-xl mb-10 flex flex-col md:flex-row md:items-center justify-between">
            <div>
                <h2 class="text-lg font-bold text-gray-200 mb-2">ARTI LOGO PELKAT PKB</h2>
            ...
            <div class="mt-4 md:mt-0 md:ml-6">
                <img loading="lazy" src="{{ asset('images/logo/pelkat_pkb.webp') }}" alt="Logo Pelkat PKB" class="w-[150px] md:w-[200px] max-w-none mx-auto">
            </div>
        </div>

        <div class="mb-10">
            <div class="bg-gray-50 border-l-4 border-[#73706F] px-8 py-8 text-center shadow">
            
                @foreach ($pelkat_pkb as $item)

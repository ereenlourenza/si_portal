...
@section('content')
    ...
    <section class="max-w-5xl mx-auto px-4 py-12 text-gray-800 leading-relaxed">
        ...
        <div class="text-center px-4 py-4">
            <img loading="lazy" src="/images/global/wilayah-pelayanan.webp" alt="Wilayah Pelayanan" class="w-full sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto my-4 h-auto rounded shadow">

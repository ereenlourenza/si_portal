    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            {{-- <pre>{{ dd($pendaftaran) }}</pre> --}}
                <form method="POST" action="{{ url('pengelolaan-informasi/pendaftaran/'.$pendaftaran->baptis_id) }}" class="form-horizontal" enctype='multipart/form-data'>
                    @csrf {!! method_field('PUT') !!} <!-- tambahkan baris ini untuk proses edit yang butuh method PUT -->
                    <input type="hidden" name="jenis" value="baptis">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" id="tempat_pernikahan" name="tempat_pernikahan" value="{{ old('tempat_pernikahan', $pendaftaran->tempat_pernikahan) }}" required>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" id="tempat_sidi_ayah" name="tempat_sidi_ayah" value="{{ old('tempat_sidi_ayah', $pendaftaran->tempat_sidi_ayah) }}" required>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="date" class="form-control" id="tanggal_sidi_ayah" name="tanggal_sidi_ayah" value="{{ old('tanggal_sidi_ayah', $pendaftaran->tanggal_sidi_ayah) }}" required>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" id="tempat_sidi_ibu" name="tempat_sidi_ibu" value="{{ old('tempat_sidi_ibu', $pendaftaran->tempat_sidi_ibu) }}" required>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="date" class="form-control" id="tanggal_sidi_ibu" name="tanggal_sidi_ibu" value="{{ old('tanggal_sidi_ibu', $pendaftaran->tanggal_sidi_ibu) }}" required>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="date" class="form-control" id="tanggal_baptis" name="tanggal_baptis" value="{{ old('tanggal_baptis', $pendaftaran->tanggal_baptis) }}" required>
                        ...
                        <div class="col-md-11">
                            @if($pendaftaran->surat_nikah_ortu)
                                <div class="mb-2">
                                    ...
                                    <a href="{{ Storage::url('images/baptis/' . $pendaftaran->surat_nikah_ortu) }}" target="_blank" class="btn btn-info btn-sm">
                            ...
                            <input type="file" class="form-control" id="surat_nikah_ortu" name="surat_nikah_ortu" accept=".jpg,.jpeg,.png" value="{{ old('surat_nikah_ortu', $pendaftaran->surat_nikah_ortu) }}">
                            @if($pendaftaran->surat_nikah_ortu)
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            @if($pendaftaran->akta_kelahiran_anak)
                                <div class="mb-2">
                                    <span class="text-danger">File sudah ada di sistem: </span>
                                    <a href="{{ Storage::url('images/baptis/' . $pendaftaran->akta_kelahiran_anak) }}" target="_blank" class="btn btn-info btn-sm">
                                        <i class="nav-icon far fa-eye"></i> Lihat File
                                    </a>
                                </div>
                            @endif
                            ...
                            <small class="form-text text-muted">.jpg,.jpeg,.png (max:2MB)</small>  
                            <input type="file" class="form-control" id="akta_kelahiran_anak" name="akta_kelahiran_anak" accept=".jpg,.jpeg,.png" value="{{ old('akta_kelahiran_anak', $pendaftaran->akta_kelahiran_anak) }}">
                            @if($pendaftaran->akta_kelahiran_anak)
                                <small class="form-text text-muted">Abaikan (jangan diisi) jika tidak ingin mengganti foto</small>
                            @endif

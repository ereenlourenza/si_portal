    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($level)
                ...
                <a href="{{ url('pengelolaan-pengguna/level') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
            @else
                <form method="POST" action="{{ url('pengelolaan-pengguna/level/'.$level->level_id) }}" class="form-horizontal">

...
@section('content')
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            @else
                <form method="POST" action="{{ url('pengelolaan-informasi/wartajemaat/'.$wartajemaat->wartajemaat_id) }}" class="form-horizontal" enctype='multipart/form-data'>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $wartajemaat->tanggal) }}" required>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $wartajemaat->deskripsi) }}">
                            @error('deskripsi')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-md-11">
                                ...
                                @endif   
                                <input type="file" class="form-control" id="file" name="file" accept=".pdf" value="{{ old('file', $wartajemaat->file) }}">
                                @if($wartajemaat->file)
